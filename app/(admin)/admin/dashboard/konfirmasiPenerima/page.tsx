                    ...
                    <div style={{ overflow: "hidden" }}>
                      <div className="grid grid-cols-2 gap-3 px-5 pt-1">
                        ...
                        <div className="border border-gray-200 rounded-lg px-4 py-3 flex items-center gap-3 bg-white">
                          ...
                          <div>
                            <p className="text-[10px] font-semibold text-gray-400 tracking-widest">INFORMASI BARANG & PENGIRIMAN</p>
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                                if (s.itemId) setActiveModal({ itemId: s.itemId, claimType: s.claimType });
                              }}

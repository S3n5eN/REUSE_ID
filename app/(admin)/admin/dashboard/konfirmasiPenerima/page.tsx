      ...
      <div className="flex justify-between items-start mb-1">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Tinjau dan verifikasi identitas pengguna sebelum pengiriman diproses
          </p>
        </div>
            ...
            >
              ...
              {isExpanded && (
                <>
                  ...
                  {/* Shipment Cost — pengganti KTP */}
                  <div className="mx-5 mt-3 rounded-lg px-4 py-3 flex items-center gap-3 bg-yellow-50 border border-yellow-200">
